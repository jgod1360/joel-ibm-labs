...
ZEN_NAMESPACE=zen
oc new-project ${ZEN_NAMESPACE}
oc project ${ZEN_NAMESPACE}

# Create the zen operator
sed -i -e s#CPD_NAMESPACE#${ZEN_NAMESPACE}#g cpd-operandrequest.yaml
...
# Create lite CR:
sed -i -e s#CPD_NAMESPACE#${ZEN_NAMESPACE}#g ibmcpd-cr.yaml
...
./check-cr-status.sh ibmcpd ibmcpd-cr ${ZEN_NAMESPACE} controlPlaneStatus
